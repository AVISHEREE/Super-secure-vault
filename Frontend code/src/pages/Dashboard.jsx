...
const Dashboard = () => {
  ...
  const getServiceLogo = (title, type = "") => {
    ...
    if (typeLower === "image")
      return "/assets/image-photo-svgrepo-com.svg";
    if (typeLower === "note")
      return "/assets/writing-note-svgrepo-com.svg";
    ...
    const iconMap = [
      ...
      {
        keyword: "instagram",
        url: "/assets/instagram-1-svgrepo-com.svg",
      },
      {
        keyword: "linkedin",
    ...
    return "/assets/file-svgrepo-com.svg";
  };
